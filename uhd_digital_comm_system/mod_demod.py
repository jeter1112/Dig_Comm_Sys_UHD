...
usage:
    ...
    demoulate(input:array,modorder:integer) ->array
...
mod_lut={
    2: np.array([-1+0j,1+0j]), #BPSK
    4: np.array([-1-1j,-1+1j,1+1j,1-1j])/np.sqrt(2), #4  QAM
    16: np.array([-3-3j,-1-3j,3-3j,1-3j,-3-1j,-1-1j,3-1j,1-1j,-3+3j,-1+3j,3+3j,1+3j,-3+1j,-1+1j,3+1j,1+1j])/np.sqrt(10), #16 QAM
    64: np.array([  (-7-7j), (-5-7j), (-1-7j), (-3-7j), (7-7j), (5-7j), (1-7j), (3-7j), \
                    ...
                    (-7+5j), (-5+5j), (-1+5j), (-3+5j), (7+5j), (5+5j), (1+5j), (3+5j), \
                    (-7+1j), (-5+1j), (-1+1j), (-3+1j), (7+1j), (5+1j), (1+1j), (3+1j), \
                    (-7+3j), (-5+3j), (-1+3j), (-3+3j), (7+3j), (5+3j), (1+3j), (3+3j)])/np.sqrt(42), #64 QAM
    256: np.array([ (-15-15j), (-13-15j), (-9-15j), (-11-15j), (-1-15j), (-3-15j), (-7-15j), (-5-15j),  \
                    ...
                    (15+7j), (13+7j), (9+7j), (11+7j), (1+7j), (3+7j), (7+7j), (5+7j), \
                    (-15+5j), (-13+5j), (-9+5j), (-11+5j), (-1+5j), (-3+5j), (-7+5j), (-5+5j), \
                    (15+5j), (13+5j), (9+5j), (11+5j), (1+5j), (3+5j), (7+5j), (5+5j)])/np.sqrt(170) #256QAM
}
...
def modulate(sdata:np.array,order:int)-> np.array:
    ...
    return np.vectorize(lambda x: mod_ord_lut[x])(decdata)    ## lamda function: index look up table to acquire symbol. vecorize method to manipulate 
